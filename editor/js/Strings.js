function Strings( config ) {
	...
	var values = {
		...
		en: {
			...
			'menubar/help': 'Help',
			'menubar/help/relw': 'Reload Window',
			'menubar/help/about': 'About',
			'menubar/help/abouttxt': 'Cot 3D Modeler\r\nVersion from 2020\r\nVer 3.1(r122)\r\nModel renderer editor by Three.js',
			...
			'sidebar/settings/language': 'Language (Reload to take changes)',
		...
		zh: {
			...
			'menubar/help': '帮助',
			'menubar/help/relw': '重载窗口',
			'menubar/help/about': '关于',
			'menubar/help/abouttxt': '小喵建模\r\n2020年版本\r\n版本V3.1(r122)\r\n模型渲染byThree.js',
			...
			'sidebar/settings': '设置',
			'sidebar/settings/language': '语言 (重载窗口以更新)',
